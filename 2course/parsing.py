"""
В соответствии с вашим номер 1 в журнале выведите на экран Имя персонажа и ссылку на него.
"""
characters = {
    "1": {
        "Rick Sanchez": {
...
name = list(character.keys())[0]
url = list(character.values())[0].keys()[0]
print(name, url)

print(list(characters['7'].keys())[0])
